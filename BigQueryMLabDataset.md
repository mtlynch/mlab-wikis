...
where `web100_var_name` is the name of a Web100 variable, as defined in [tcp-kis.txt][10] (field `VariableName`). |  See Web100 types |  [tcp-kis.txt][10] defines 150 Web100 variables.  
...
[7]: /bigquery/docs/cli_tool
[8]: http://www.measurementlab.net/
[9]: http://www.maxmind.com/
[10]: /bigquery/docs/tcp-kis.txt
[11]: http://tools.ietf.org/html/rfc4898
[12]: /bigquery/docs/query-reference.html#comparisonfunctions
[13]: /bigquery/docs/query-reference.html#timestampfunctions
[14]: /bigquery/docs/query-reference.html#ipfunctions
[15]: /bigquery/docs/query-reference#groupby
